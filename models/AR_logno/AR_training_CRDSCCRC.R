...
write.csv(AR_train, "../../data/predictions_logno/train_CRDSCCRC.csv", row.names = FALSE)
write.csv(AR_test, "../../data/predictions_logno/test_CRDSCCRC.csv", row.names = FALSE)
