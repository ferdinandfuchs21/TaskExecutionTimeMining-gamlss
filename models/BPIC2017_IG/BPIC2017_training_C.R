...
BPIC2017_train_filtered <- BPIC2017_train %>%
  filter(duration_seconds > 0, duration_seconds <= q99)

mu_formula <- duration_seconds ~ 1
sigma_formula <- ~ 1
...
write.csv(BPIC2017_train, "../../data/BPIC2017/predictions_IG/train_C.csv", row.names = FALSE)
write.csv(BPIC2017_test, "../../data/BPIC2017/predictions_IG/test_C.csv", row.names = FALSE)
