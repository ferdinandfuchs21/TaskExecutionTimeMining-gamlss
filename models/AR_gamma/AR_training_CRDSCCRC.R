...
write.csv(AR_train, "../../data/predictions_gamma/train_CRDSCCRC.csv", row.names = FALSE)
write.csv(AR_test, "../../data/predictions_gamma/test_CRDSCCRC.csv", row.names = FALSE)
