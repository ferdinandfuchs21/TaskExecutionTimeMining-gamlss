...
AR_train <- read_csv("../../data/AR/transformed_event_logs/AR_train.csv")
AR_test  <- read_csv("../../data/AR/transformed_event_logs/AR_test.csv")
...
write.csv(AR_train, "../../data/AR/predictions_gamma/train_C.csv", row.names = FALSE)
write.csv(AR_test, "../../data/AR/predictions_gamma/test_C.csv", row.names = FALSE)
