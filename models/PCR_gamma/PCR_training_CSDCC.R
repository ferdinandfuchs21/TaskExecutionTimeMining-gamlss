...
write.csv(PCR_train, "../../data/PCR/predictions_gamma/train_CSDCC.csv", row.names = FALSE)
write.csv(PCR_test, "../../data/PCR/predictions_gamma/test_CSDCC.csv", row.names = FALSE)
