...
write.csv(PCR_train, "../../data/PCR/predictions_gamma/train_CSD.csv", row.names = FALSE)
write.csv(PCR_test, "../../data/PCR/predictions_gamma/test_CSD.csv", row.names = FALSE)
