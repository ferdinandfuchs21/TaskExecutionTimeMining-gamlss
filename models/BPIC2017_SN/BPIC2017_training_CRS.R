...
write.csv(BPIC2017_train, "../../data/BPIC2017/predictions_SN/train_CRS.csv", row.names = FALSE)
write.csv(BPIC2017_test, "../../data/BPIC2017/predictions_SN/test_CRS.csv", row.names = FALSE)
