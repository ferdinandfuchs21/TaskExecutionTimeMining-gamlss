...
write.csv(PCR_train, "../../data/PCR/predictions_logno/train_CSDCC.csv", row.names = FALSE)
write.csv(PCR_test, "../../data/PCR/predictions_logno/test_CSDCC.csv", row.names = FALSE)
