...
write.csv(BPIC2017_train, "../../data/BPIC2017/predictions_logno/train_R.csv", row.names = FALSE)
write.csv(BPIC2017_test, "../../data/BPIC2017/predictions_logno/test_R.csv", row.names = FALSE)
