...
write.csv(BPIC2017_train, "../../data/BPIC2017/predictions_logno/train_C.csv", row.names = FALSE)
write.csv(BPIC2017_test, "../../data/BPIC2017/predictions_logno/test_C.csv", row.names = FALSE)
