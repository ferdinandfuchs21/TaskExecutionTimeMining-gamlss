...
BPIC2017_train <- BPIC2017_train %>% rename(variable2 = `day_of_week`)
BPIC2017_test  <- BPIC2017_test %>% rename(variable2 = `day_of_week`)
...
BPIC2017_train <- BPIC2017_train %>% rename(`org:resource_start` = variable1)
BPIC2017_test  <- BPIC2017_test %>% rename(`org:resource_start` = variable1)
BPIC2017_train <- BPIC2017_train %>% rename(`day_of_week` = variable2)
BPIC2017_test  <- BPIC2017_test %>% rename(`day_of_week` = variable2)

write.csv(BPIC2017_train, "../../data/BPIC2017/predictions_logno/train_RD.csv", row.names = FALSE)
write.csv(BPIC2017_test, "../../data/BPIC2017/predictions_logno/test_RD.csv", row.names = FALSE)
