...
write.csv(AR_train, "../../data/predictions_inversegaussian/train_CRDSCC.csv", row.names = FALSE)
write.csv(AR_test, "../../data/predictions_inversegaussian/test_CRDSCC.csv", row.names = FALSE)
