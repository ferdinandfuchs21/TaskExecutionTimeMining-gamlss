...
write.csv(AR_train, "../../data/predictions_inversegaussian/train_CR.csv", row.names = FALSE)
write.csv(AR_test, "../../data/predictions_inversegaussian/test_CR.csv", row.names = FALSE)
