...
write.csv(BPIC2017_train, "../../data/BPIC2017/predictions_gamma/train_CRSD.csv", row.names = FALSE)
write.csv(BPIC2017_test, "../../data/BPIC2017/predictions_gamma/test_CRSD.csv", row.names = FALSE)
